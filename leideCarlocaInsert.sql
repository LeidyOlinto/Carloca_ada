...
INSERT INTO `MODELO` (`id_modelo`,`nome`, `id_categoria`, `id_montadora`, `id_versao`) VALUES (1,'Onix',1, 1, 1);
INSERT INTO `MODELO` (`id_modelo`, `nome`, `id_categoria`, `id_montadora`, `id_versao`) VALUES (2,'Civic', 2, 3, 4);
INSERT INTO `MODELO` (`id_modelo`, `nome`, `id_categoria`, `id_montadora`, `id_versao`) VALUES (3,'Bugg' ,5, 5, 5);
INSERT INTO `MODELO` (`id_modelo`, `nome`, `id_categoria`, `id_montadora`, `id_versao`) VALUES (4,'LandRover', 3, 4, 3);
INSERT INTO `MODELO` (`id_modelo`, `nome`, `id_categoria`, `id_montadora`, `id_versao`) VALUES (5,'Discovery', 4, 2, 2);
...
INSERT INTO `LOCADORA` (`id_locadora`, `nome`, `id_endereco`) VALUES (1, 'VEICULOS LUXS', 1);
...
INSERT INTO `LOCADORA` (`id_locadora`, `nome`, `id_endereco`) VALUES (4, 'LOCACAO FELIX', 4);
